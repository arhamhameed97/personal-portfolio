...
export const colorZones = [
  { start: 0, end: 100, startColor: "#ffffff", endColor: "#ffffff", textColor: "#0a0a0a" }, // Hero
  { start: 100, end: 200, startColor: "#ffffff", endColor: "#f5f5f5", textColor: "#0a0a0a" }, // About start
